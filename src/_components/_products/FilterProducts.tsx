    ...
    <div className='w-full flex items-center gap-4.5'>
      {dummyFilters.map((button) => (
        ...
        >
          ...
          <button
            ...
            } outline-none border border-neutral-400 dark:border-neutral-700 rounded-lg shadow-sm cursor-pointer flex items-center justify-center py-1.5 px-4.5 text-sm font-medium tracking-wider hover:bg-orange-500 focus-visible:bg-orange-500 hover:border-orange-500 focus-visible:border-orange-500 hover:shadow-lg focus-visible:shadow-lg hover:text-white focus-visible:text-white transition-all duration-500`}
          >
            {button.label}
          </button>
        </form>
      ...
      <form method='GET'>
        <button
          ...
          className='outline-none border border-transparent rounded-lg shadow-sm flex items-center justify-center py-1.5 px-4.5 bg-red-400 dark:bg-red-500 text-white text-sm font-medium tracking-wider cursor-pointer disabled:cursor-not-allowed disabled:opacity-50 not-disabled:hover:bg-red-700 not-disabled:focus-visible:bg-red-700 not-disabled:hover:shadow-lg not-disabled:focus-visible:shadow-lg transition-all duration-500'
        >
          Remove Filter
        </button>
      </form>
