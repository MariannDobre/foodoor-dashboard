  ...
  return (
    <div className='w-full h-full flex flex-col gap-4.5 overflow-y-auto'>
      {cartData?.length > 0 ? (
        ...
        <div className='w-full h-auto p-6 flex flex-col gap-3 items-center justify-center rounded-lg shadow-sm border border-neutral-400 dark:border-neutral-700'>
          ...
          <Link
            href='/restaurants'
            className='outline-none border-none cursor-pointer bg-orange-500 text-white rounded-lg shadow-sm text-sm font-medium tracking-wider py-1.5 px-6 hover:bg-orange-700 focus-visible:bg-orange-700 transition-all duration-500'
          >
            Browse Restaurants
          </Link>
        </div>
